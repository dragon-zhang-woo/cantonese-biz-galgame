...
1. 从“金钟入职”开始，切换到“AI 即兴”；
2. 自己输入一句商务回应，展示双模型角色反应、港式改写与关系分数；
3. 切回标准剧情，证明网络故障不会破坏 Demo；
4. 刷新页面展示断点续玩，或用右上角按钮一键重新开始；
5. 完成五幕，在学习报告页展示个人沟通画像。
...
- 代码、故事、人物和交互结构为本项目原创；
- 31 张正式游戏视觉资产均为项目专门生成，包括五张主场景、五张建立镜头、
  十二张剧情插图、五组人物反应和四张角色锚点；记录见
